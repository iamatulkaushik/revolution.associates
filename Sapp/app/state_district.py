...
class DistrictForm(ModelForm):
    ...
    def create_default_states_and_districts(sender, app_config, **kwargs):
        ...
        states_and_districts = {
            ...
            "haryana": ["ambala", "bhiwani", "charkhi dadri", "faridabad", "fatehabad", "gurgaon", "hisar", "jind", "kaithal", "karnal", "kurukshetra", "mahabaleshwar", "mewat", "palwal", "panipat", "rewari", "rohtak", "sirsa", "sonipat", "yugpur"],
